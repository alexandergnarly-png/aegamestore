...
const translations = {
  id: {
    ...
    heroTitle: "Top up game key, rapi dan cepat.",
    heroDesc:
      "Pilih game, cek stok, lalu bayar dengan tampilan yang lebih clean dan ringan di mobile.",
  ...
  en: {
    ...
    heroDesc:
      "Pick a game, check stock, and pay with a cleaner mobile-first experience.",
