...
assert.match(html, /script\.js\?v=20260813-auto-promo-1/);
assert.match(html, /style\.css\?v=20260813-auto-promo-1/);
assert.match(html, /keysystem-ui\.css\?v=20260814-trust-cards-1/);
assert.match(serviceWorker, /CACHE_VERSION = "20260814-trust-cards-v1"/);
