...
assert.match(html, /keysystem-ui\.css\?v=20260811-mobile-footer-1/);
assert.match(serviceWorker, /CACHE_VERSION = "20260811-mobile-footer-v1"/);
...
assert.match(keysystemCss, /\.payment-icons button \{[\s\S]*?min-height: 48px/);
