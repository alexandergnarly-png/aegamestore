...
assert.match(css, /AE patch 20260825-checkout-docket-v2/);
...
assert.match(html, /script\.js\?v=20260825-checkout-docket-v2/);
assert.match(html, /style\.css\?v=20260825-checkout-docket-v2/);
...
assert.match(serviceWorker, /CACHE_VERSION = "20260825-checkout-docket-v2"/);
