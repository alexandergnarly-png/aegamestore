...
assert.match(html, /script\.js\?v=20260811-usdt-success-modal-2/);
assert.match(html, /style\.css\?v=20260811-usdt-success-modal-2/);
assert.match(html, /keysystem-ui\.css\?v=20260811-header-controls-2/);
assert.match(serviceWorker, /CACHE_VERSION = "20260811-usdt-success-modal-v2"/);
