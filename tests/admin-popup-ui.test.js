...
[
  ...
  "Sinkron Supplier",
  'id="convertVipStoreToLocalBtn"',
  "convertVipStoreProductsToLocal",
  "Jadikan Stok Lokal",
  "Produk tanpa key lokal akan tampil habis.",
  ...
  'class="admin-more-sheet-kicker">AE / Operasional toko</small>',
  'class="admin-more-sheet-scroll"',
