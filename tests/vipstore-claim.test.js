...
const checkoutFailureContext = vm.createContext({});
vm.runInContext(server.slice(server.indexOf("function supplierCheckoutFailure("), server.indexOf("async function syncAllMappedSupplierProducts(")), checkoutFailureContext);
