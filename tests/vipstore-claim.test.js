...
assert.throws(() => validateCatalog({ ok: false, http_code: 402, diagnostic_message: "Catalog temporarily unavailable", data: { success: false } }), /Pesan supplier: Catalog temporarily unavailable/);
