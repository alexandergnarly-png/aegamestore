...
const offers = buildSupplierComparison(100000, [
  ...
  { supplier_source: "alternate", price_idr: 69000, stock: 2, status: "ready", last_sync: "2026-08-08T07:58:00.000Z" },
  { supplier_source: "stale", price_idr: 1000, stock: 9, status: "ready", last_sync: "2026-08-08T07:00:00.000Z" },
], now);

assert.equal(offers.find((offer) => offer.supplier_source === "alternate").cheapest, true);
...
assert.equal(offers.find((offer) => offer.supplier_source === "alternate").profit, 31000);
