...
app.post("/create-qris-order", orderLimiter, async (req, res) => {
  ...
  try {
    ...
    await query(
      `INSERT INTO orders
      (id, product_id, user_id, access_token, name, contact, game, product, price, original_price, discount_amount, payment_fee, voucher_code, payment_status, delivery_status, created_at, payment_type)
      VALUES
